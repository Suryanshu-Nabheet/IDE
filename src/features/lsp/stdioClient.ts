...
// Keep DiagnosticWithAction local if it depends on complex types,
// or move it to lspTypes if generalized.
// For now, removing it from here as it wasn't used in preload.
// But wait, if I remove it, I must ensure it is not used in stdioClient or imported elsewhere.
